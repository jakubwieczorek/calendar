...
public class AdminController
{
    ...
    public ResponseEntity<Void> createUser(@RequestBody PersonDTO aUser)
    {
        ...
        return new ResponseEntity<>((Void) null, HttpStatus.CONFLICT);
    }
    ...
    public ResponseEntity<Void> updateUser(@PathVariable(value = "mail") String aMail, @RequestBody PersonDTO aUser)
    {
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable(value = "mail") String aMail)
    {
